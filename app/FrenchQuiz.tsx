...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: ['No', 'Yes', 'Thank you', 'See you later'],
    answerIndex: 2,
  },
  {
    question: 'What does "Au revoir" mean?',
    options: ['Goodbye', 'Hello', 'Please', 'No'],
    answerIndex: 0,
  },
];

export default function FrenchQuizScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>French Quiz</Text>
